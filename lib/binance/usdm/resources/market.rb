  ...
  module USDM
    module Resources
      ...
      module MarketClassMethods
        ...
        # @example Binance::USDM::Resources::Market.ticker_24h(symbol: "ETHUSDT")
        ...
        # @example Binance::USDM::Resources::Market.price("ETHUSDT")
        # @example Binance::USDM::Resources::Market.price(symbol: "ETHUSDT")
        ...
        # @example Binance::USDM::Resources::Market.funding_rate_history(symbol: "ETHUSDT")
        ...
        # @example Binance::USDM::Resources::Market.open_interest(symbol: "ETHUSDT")
        def open_interest(symbol:)
          client.market.open_interest(symbol: symbol)
        end

        # Get exchange info (class method)
        # @example Binance::USDM::Resources::Market.exchange_info
        def exchange_info
          client.market.exchange_info
        end

        # Get all instruments/symbols (class method)
        # @example Binance::USDM::Resources::Market.instruments
        def instruments
          client.market.instruments
        end

        # Find a specific symbol by name
        # @example Binance::USDM::Resources::Market.find_symbol("ETHUSDT")

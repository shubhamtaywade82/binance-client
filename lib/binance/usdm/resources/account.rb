  ...
  module USDM
    module Resources
      ...
      module AccountClassMethods
        ...
        # @example Binance::USDM::Resources::Account.info
        def info
          client.account.info
        end

        # Get account balances (class method)
        # @example Binance::USDM::Resources::Account.balance
        def balance
          client.account.balance
        end

        # Get positions (class method)
        # @example Binance::USDM::Resources::Account.positions(symbol: "ETHUSDT")
        def positions(symbol: nil)
          client.account.positions(symbol: symbol)
        end

        # Change position mode (class method)
        # @example Binance::USDM::Resources::Account.change_position_mode(dual_side_position: true)
        ...
        # @example Binance::USDM::Resources::Account.position_mode
        def position_mode
          client.account.position_mode
        end

        # Change initial leverage (class method)
        # @example Binance::USDM::Resources::Account.change_leverage(symbol: "ETHUSDT", leverage: 10)
        ...
        # @example Binance::USDM::Resources::Account.change_margin_mode(symbol: "ETHUSDT", margin_mode: "ISOLATED")
        ...
        # @example Binance::USDM::Resources::Account.modify_position_margin(symbol: "ETHUSDT", amount: "100", type: 1)
        ...
        # @example Binance::USDM::Resources::Account.position_margin_history(symbol: "ETHUSDT")
        ...
        # @example Binance::USDM::Resources::Account.income_history(symbol: "ETHUSDT", income_type: "COMMISSION")
        ...
        # @example Binance::USDM::Resources::Account.commission_rate(symbol: "ETHUSDT")

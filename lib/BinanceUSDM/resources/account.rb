    ...
    class Account < BaseAPI
      ...
      class << self
        ...
        def modify_position_margin(symbol:, amount:, type:, position_side: "BOTH")
          client.account.modify_position_margin(symbol: symbol, amount: amount, type: type, position_side: position_side)
        end
        ...
        def position_margin_history(symbol:, type: nil, start_time: nil, end_time: nil, limit: 500)
          client.account.position_margin_history(symbol: symbol, type: type, start_time: start_time, end_time: end_time, limit: limit)
        end
        ...
        def income_history(symbol: nil, income_type: nil, start_time: nil, end_time: nil, limit: 500)
          client.account.income_history(symbol: symbol, income_type: income_type, start_time: start_time, end_time: end_time, limit: limit)
        end

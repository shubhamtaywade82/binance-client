...
module BinanceUSDM
  # Binance error code mappings for trade, validation, and order failures.
  # See: https://binance-docs.github.io/apidocs/futures/en/#error-codes
  module ErrorCodesCore
    CODES = {
  ...
  # Binance error code mappings for account, authentication, and authorization failures.
  module ErrorCodesAccount
    CODES = {

...
MANIFEST = {
  ...
  'Institutional Loan REST API' => { product: :institutional_loan, host: 'https://api.binance.com', time_path: '/api/v3/time' },
  'Discount Buy REST API' => { product: :discount_buy, host: 'https://api.binance.com', time_path: '/api/v3/time' },
  'Dual Investment REST API' => { product: :dual_investment, host: 'https://api.binance.com', time_path: '/api/v3/time' },
  ...
  'Spot Block Matching REST API' => { product: :block_matching, host: 'https://api.binance.com', time_path: '/api/v3/time' },
